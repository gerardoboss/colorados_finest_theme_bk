...
<div id="page" class="site">
   ...
   <video playsinline autoplay loop muted  class="video" ><source src="<?php bloginfo('stylesheet_directory'); ?>/images/video.mp4" type="video/mp4" /></video>
            ...
            <div class="col-lg-2 col-md-3 col-sm-3 col-12 mt-3 mb-3 mt-md-0 mb-md-0 icons">
                <div class="container">
                    <div class="row">
                        ...
                        <button type="button" class="btn btn-warning btn-round-colorado"
                                onclick="window.location.href='shop'">SHOP OUR PRODUCTS
                        </button>
