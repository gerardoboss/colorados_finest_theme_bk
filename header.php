				...
				<div class="col-md-2">
					<div class="container">
						<div class="row">
							...
							<div class="col-md-4 product_items"><img src="<?php echo get_stylesheet_directory_uri() ?>/images/menu.png" alt="Menu"></div>
						</div>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="more_products col-md-12 d-flex align-items-end justify-content-center">
					<button type="button" class="btn btn-outline-warning"  onclick="window.location.href='shop'">SHOP OUR PRODUCTS</button>
				</div>
			</div>
		</div>
